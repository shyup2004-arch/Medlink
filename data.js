const latestLectureData = {
    ...
    "reviewQuiz": [
        ...
        { "question": "세포막을 완전히 관통하는 단백질을 무엇이라고 부르나요? (영문 포함)", "answer": "내재성 막 단백질 (Integral membrane protein)" }
    ]
};
