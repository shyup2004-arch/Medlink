const latestLectureData = {
    ...
    "professor": "김재봉",
    "summary": "세포의 에너지 대사를 이해하는 핵심 챕터입니다. 에너지를 어떻게 얻고(이화작용), 어떻게 사용하는지(동화작용)를 ATP라는 화폐를 중심으로 배웁니다. 김재봉 교수님은 **각 과정의 특정 중간산물**을 묻는 단답형을 선호하시니, 큰 흐름과 함께 핵심 분자 이름을 암기하는 것이 중요합니다.<br><h4>🔑 핵심 암기 사항</h4><ul><li><strong>자유 에너지(Gibbs Free Energy, ΔG):** ΔG가 음수(-)일 때 자발적 반응이라는 개념을 이해해야 합니다.</li><li><strong>ATP (Adenosine Triphosphate):** 세포의 에너지 화폐. ATP가 ADP로 가수분해될 때 방출되는 에너지를 통해 비자발적 반응을 진행시킵니다.</li><li><strong>해당과정(Glycolysis):** 포도당을 피루브산(pyruvate)으로 분해하며 ATP와 NADH를 얻는 과정. 세포질에서 일어납니다.</li><li><strong>TCA 회로(Krebs Cycle):** 피루브산이 아세틸 CoA(Acetyl CoA)로 전환된 후, 미토콘드리아 기질에서 완전히 산화되며 대량의 NADH와 FADH2를 생성하는 과정.</li><li><strong>산화적 인산화(Oxidative Phosphorylation):** NADH와 FADH2의 전자를 이용, 미토콘드리아 내막의 전자전달계(Electron transport chain)를 거쳐 최종적으로 ATP를 대량 생산하는 과정.</li></ul><h4><span class=\"text-red\">❗️ 기출 연관 중요 개념</span></h4><ul><li><strong>TCA 회로의 첫 산물:</strong> <span class=\"text-red\">2023년 1차 시험</span>에서 **옥살아세트산(Oxaloacetate)과 아세틸 CoA가 만나 생성되는 첫 6탄당**을 묻는 문제가 출제되었습니다. 정답은 **시트르산(Citrate)**입니다.</li><li><strong>해당과정의 3탄당:</strong> 포도당이 2개의 3탄당으로 쪼개진 후의 산물을 묻는 문제가 출제되었습니다. **Glyceraldehyde-3-phosphate (G3P)**와 **Dihydroxyacetone phosphate (DHAP)**를 기억해야 합니다.</li><li><strong>전자전달계 복합체:** <span class=\"text-red\">(2023년 1차 시험 출제)</span> 전자를 전달하는 **Complex I, III, IV**를 통해 양성자(H+)가 펌핑된다는 사실을 알아야 합니다.</li></ul><h4>🧪 주요 용어</h4><ul><li><strong>기질 수준 인산화(Substrate-level phosphorylation):** 해당과정과 TCA 회로에서 일어나는 소량의 ATP 생성 방식.</li><li><strong>화학삼투(Chemiosmosis):** 산화적 인산화에서 양성자 기울기를 이용해 ATP를 합성하는 원리.</li></ul>",
    "reviewQuiz": [
        ...
        { "question": "해당과정(Glycolysis)과 TCA 회로에서 생성되어, 산화적 인산화 단계에 전자를 제공하는 두 가지 주요 전자 운반체는 무엇인가요?", "source": "AI 예상 문제", "answer": "NADH와 FADH2" },
        { "question": "세포의 '에너지 화폐'로 불리며, 가수분해될 때 에너지를 방출하여 다른 생화학 반응을 촉진하는 분자는 무엇인가요?", "source": "AI 예상 문제", "answer": "ATP (Adenosine Triphosphate)" }
    ]
};
